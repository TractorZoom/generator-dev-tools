...
const addCommitlintConfiguration = context => {
  ...
  fs.copyFileSync(
    context.templatePath("commitlint.config.js"),
    context.destinationPath("commitlint.config.js")
  );
};
...
const addPrettierConfiguration = context => {
  ...
  fs.copyFileSync(
    context.templatePath("prettier.config.js"),
    context.destinationPath("prettier.config.js")
  );
};
...
const addTerraformConfiguration = context => {
  ...
  fs.copyFileSync(
    context.templatePath("terraform-format.sh"),
    context.destinationPath("terraform-format.sh")
  );
};
...
module.exports = class extends Generator {
  ...
  writing() {
    const shouldAddHuskyConfig =
      this.answers.commitlint ||
      this.answers.prettier ||
      this.answers.terraform;
