...
Add build status badge for publish step to your projects README: [![Publish Status](https://github.com/TractorZoom/-tractorzoom generator dev tools/workflows/publish/badge.svg)](https://github.com/TractorZoom/-tractorzoom generator dev tools/actions)

Add build status badge for PR verify step to your projects README: [![Publish Status](https://github.com/TractorZoom/-tractorzoom generator dev tools/workflows/pull_request/badge.svg)](https://github.com/TractorZoom/-tractorzoom generator dev tools/actions)
